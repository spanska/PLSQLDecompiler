...
public class Unwrap {
	...
	private static String getDataToDecode(BufferedReader br,
			int dataToDecodeLength) throws IOException {
	...
	public static void decodeFile(File inFile, File outFile)
	...
	public static void decodeDir(File inDir, File outDir) throws FileNotFoundException,
		...
		if (!outDir.mkdir()) {
			System.err.println("Erreur ==> Impossible de créer ce dossier: "
			...
			for (int i = 0; i < files.length; i++) {
				...
				System.out.println("Décryptage du fichier ==> "
						+ inFile.getName());
				String newFileName = inFile.getName().replaceAll(".plb",
						".sql");
